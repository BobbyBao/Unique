...
namespace Unique
{
    ...
    */
    ...
    typedef List<AbstractNodePtr> AbstractNodeList;
    typedef std::shared_ptr<AbstractNodeList> AbstractNodeListPtr;

    class UNIQUE_API AbstractNode
    {
    public:
        String file;
        unsigned int line;
    ...
    class UNIQUE_API AtomAbstractNode : public AbstractNode
    {
    public:
        String value;
        uint id;
    ...
    class UNIQUE_API ObjectAbstractNode : public AbstractNode
    {
    private:
        HashMap<String,String> mEnv;
    public:
        String name, cls;
        Vector<String> bases;
        uint id;
    ...
    public:
        ...
        const HashMap<String,String> &getVariables() const;
    };

    /** This abstract node represents a script property */
    class UNIQUE_API PropertyAbstractNode : public AbstractNode
    {
    public:
        String name;
        uint id;
    ...
    class UNIQUE_API ImportAbstractNode : public AbstractNode
    {
    public:
    ...
    class UNIQUE_API VariableAccessAbstractNode : public AbstractNode
    {
    public:
        String name;
    public:
    ...
    */
    class UNIQUE_API ScriptCompiler
    {
    public: // Externally accessible types
        ...
        typedef List<ErrorPtr> ErrorList;
    ...
    public:
        ...
        void addError(uint code, const String &file, int line, const String &msg = "");
		...
		*/
		uint registerCustomWordId(const String &word);
    ...
    private:
		...
		uint mLargestRegisteredWordId;

        // This is an environment map
        typedef HashMap<String,String> Environment;
        Environment mEnv;

        typedef HashMap<String,AbstractNodeListPtr> ImportCacheMap;
    ...
    */
    class UNIQUE_API ScriptCompilerListener
    {
    public:
        ...
        virtual void handleError(ScriptCompiler *compiler, uint code, const String &file, int line, const String &msg);
    ...
    */
    class UNIQUE_API ScriptCompilerManager : public ScriptLoader
    {
    private:
        //    OGRE_AUTO_MUTEX;
        ...
        Vector<ScriptTranslatorManager*> mManagers;
...
//        OGRE_THREAD_POINTER(ScriptCompiler, mScriptCompiler);
    ...
    class UNIQUE_API PreApplyTextureAliasesScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        Material *mMaterial;
    ...
    class UNIQUE_API ProcessResourceNameScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        enum ResourceType
        {
    ...
    class UNIQUE_API ProcessNameExclusionScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        String mClass;
    ...
    class UNIQUE_API CreateMaterialScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
    ...
    class UNIQUE_API CreateGpuProgramScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
    ...
    class UNIQUE_API CreateHighLevelGpuProgramScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
    ...
    class UNIQUE_API CreateGpuSharedParametersScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        String mFile, mName, mResourceGroup;
        static String eventType;
    ...
    class UNIQUE_API CreateParticleSystemScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        String mFile, mName, mResourceGroup;
        static String eventType;
    ...
    class UNIQUE_API CreateCompositorScriptCompilerEvent : public ScriptCompilerEvent
    {
    public:
        String mFile, mName, mResourceGroup;
        static String eventType;
