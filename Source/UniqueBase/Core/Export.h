...
#define DEFINE_FUNC_7(clss, typeRet, func, type1, type2, type3, type4)\
...
#define DEFINE_STATIC_FUNC_5(clss, typeRet, func, type1, type2)\
UNIQUE_C_API typeRet clss##_##func(type1 param1, type2 param2)\
{\
	return (typeRet)clss::func((type1)param1, (type2)param2);\
}

#define DEFINE_STATIC_FUNC_6(clss, typeRet, func, type1, type2, type3)\
...
#define DEFINE_STATIC_FUNC_7(clss, typeRet, func, type1, type2, type3, type4)\
...
#define DEFINE_STATIC_FUNC_8(clss, typeRet, func, type1, type2, type3, type4, type5)\
...
#define DEFINE_STATIC_FUNC_9(clss, typeRet, func, type1, type2, type3, type4, type5, type6)\
